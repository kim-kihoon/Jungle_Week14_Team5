...
void FEditorSceneManagerWidget::Initialize(UEditorEngine* InEditorEngine)
{
	FEditorWidget::Initialize(InEditorEngine);
}

void FEditorSceneManagerWidget::Render(float DeltaTime)
{
	(void)DeltaTime;
...
void FEditorSceneManagerWidget::RenderActorOutliner(FSelectionManager& Selection)
{
...
void FEditorSceneManagerWidget::RenderActorNode(AActor* Actor, const TArray<AActor*>& Actors, FSelectionManager& Selection)
{
	if (!IsValid(Actor))
	{
		return;
...
void FEditorSceneManagerWidget::RenderSceneComponentNode(USceneComponent* Comp, FSelectionManager& Selection)
{
...
void FEditorSceneManagerWidget::RenderNonSceneComponents(AActor* Actor, FSelectionManager& Selection)
{
	if (!IsValid(Actor))
	{
		return;
...
void FEditorSceneManagerWidget::RenderActorContextMenu(AActor* Actor, FSelectionManager& Selection)
{
	if (!IsValid(Actor))
	{
		return;
...
void FEditorSceneManagerWidget::RenderComponentContextMenu(UActorComponent* Component, FSelectionManager& Selection)
{
...
void FEditorSceneManagerWidget::RenderAddComponentMenu(AActor* Actor, USceneComponent* AttachParent, FSelectionManager& Selection)
{
	if (!IsValid(Actor))
	{
		return;
...
UActorComponent* FEditorSceneManagerWidget::AddComponentToActor(
	AActor* Actor,
...
void FEditorSceneManagerWidget::RemoveComponentFromActor(UActorComponent* Component, FSelectionManager& Selection)
{
	if (!IsValid(Component))
	{
		return;
